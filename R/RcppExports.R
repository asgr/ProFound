...
profoundAperWeight <- function(cx, cy, rad, dimx = 100L, dimy = 100L, wt = as.numeric( c(1)), rad_re = as.numeric( c(0)), depth = 3L, nthreads = 1L) {
    .Call(`_ProFound_profoundAperWeight`, cx, cy, rad, dimx, dimy, wt, rad_re, depth, nthreads)
}

profoundAperFlux <- function(image, cx, cy, rad, wt = as.numeric( c(1)), rad_re = as.numeric( c(0)), deblend = FALSE, depth = 3L, nthreads = 1L) {
    .Call(`_ProFound_profoundAperFlux`, image, cx, cy, rad, wt, rad_re, deblend, depth, nthreads)
}
...
profoundEllipWeight <- function(cx, cy, rad, ang = as.numeric( c(0)), axrat = as.numeric( c(1)), dimx = 100L, dimy = 100L, wt = as.numeric( c(1)), rad_re = as.numeric( c(0)), depth = 3L, nthreads = 1L) {
    .Call(`_ProFound_profoundEllipWeight`, cx, cy, rad, ang, axrat, dimx, dimy, wt, rad_re, depth, nthreads)
}

profoundEllipFlux <- function(image, cx, cy, rad, ang = as.numeric( c(0)), axrat = as.numeric( c(1)), wt = as.numeric( c(1)), rad_re = as.numeric( c(0)), deblend = FALSE, depth = 3L, nthreads = 1L) {
    .Call(`_ProFound_profoundEllipFlux`, image, cx, cy, rad, ang, axrat, wt, rad_re, deblend, depth, nthreads)
}
