...
profoundAperWeight <- function(cx, cy, rad, dimx = 100L, dimy = 100L, wt = as.numeric( c(1)), rad_re = as.numeric( c(0)), nser = as.numeric( c(1)), depth = 3L, nthreads = 1L) {
...
profoundEllipWeight <- function(cx, cy, rad, ang = as.numeric( c(0)), axrat = as.numeric( c(1)), dimx = 100L, dimy = 100L, wt = as.numeric( c(1)), rad_re = as.numeric( c(0)), nser = as.numeric( c(1)), depth = 3L, nthreads = 1L) {
