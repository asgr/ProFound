...
The **ProFound** source finding and image utilities suite covers the following functions:
...
- profoundAperPhot: Extract circular photometry using images with segmentation maps
...
- profoundAperFlux: Extract circular aperture photometry directly
- profoundEllipFlux: Extract circular aperture photometry directly
...
- profoundAperCover: Create circular aperture coverage maps
- profoundEllipCover: Create elliptical aperture coverage maps
