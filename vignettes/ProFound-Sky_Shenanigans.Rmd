...
vignette: >
  %\VignetteIndexEntry{ProFound: Sky Shenanigan}
...
An ongoing question is whether you can do better by using **ProFound** to model the background for a given source. The three obvious options are:
