...
```{r, fig.width=6, fig.height=6, dpi=40}
magimage(profoundPixelCorrelation(im_test, skyRMS=10, plot=TRUE)$fft, xlab='kx (356/pix)', ylab='ky (356/pix)'); points(0,0,cex=5,col='red')

magimage(profoundPixelCorrelation(im_test_sub, skyRMS=10, plot=TRUE)$fft, xlab='kx (356/pix)', ylab='ky (356/pix)'); points(0,0,cex=5,col='red')

magimage(profoundPixelCorrelation(im_test_fin, skyRMS=1, plot=TRUE)$fft, xlab='kx (356/pix)', ylab='ky (356/pix)'); points(0,0,cex=5,col='red')

magimage(profoundPixelCorrelation(matrix(rnorm(1e6, mean=0, sd=10), 1000), skyRMS=10, plot=TRUE)$fft, xlab='kx (356/pix)', ylab='ky (356/pix)'); points(0,0,cex=5,col='red')
```
