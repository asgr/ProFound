...
```{r, fig.width=8, fig.height=8}
R50 = 2 #Re in pixels
R100 = 19 #Maximum radius to use for the apertures
...
```{r}
#The above FitMagPSF fit suggests a sky pedestal should be added to the image:

sky = sum(newmag$image - newmag$finalmodel)/(120^2)
...
```{r}
magplot(newmag$psfstats$mag, newmag$psfstats$mag - newmag_wt, xlim=c(11,18), ylim=c(-2,2))
```