...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::Function >::type Fquantile(FquantileSEXP);
    ...
    Cadacs_MakeSkyGrid(image, sky, skyRMS, Fquantile, objects, mask, box1, box2, grid1, grid2, boxadd1, boxadd2, type, skypixmin, boxiters, doclip, skytype, skyRMStype, sigmasel);
    return R_NilValue;
END_RCPP
}
// water_cpp
